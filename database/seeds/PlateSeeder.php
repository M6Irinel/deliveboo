...
class PlateSeeder extends Seeder
{
    ...
    public function run()
    {
        $plates = [
            ...
            [
                'restaurant_id' => 6,
                'plate_name' => 'Pasta panna e salmone',
                'ingredients' => 'Pasta, Salmone',
                'plate_description' => 'Pasta italiana con panna e salmone',
                'plate_price' => 8.00,
                'visibility' => 1,
                'plate_image' => 'plate_img/Farfalle-al-salmone.jpg',
            ],
            [
                'restaurant_id' => 6,
                'plate_name' => 'Focaccia caprese',
                'ingredients' => 'Focaccia, Mozzarella, Pomodoro',
                'plate_description' => 'Focaccia con ripieno di mozzarella e pomodoro',
                'plate_price' => 6.50,
                'visibility' => 1,
                'plate_image' => 'plate_img/focaccia-prosciutto-cotto-o-caprese-1-720x480.jpeg',
            ],
            [
                'restaurant_id' => 6,
                'plate_name' => 'Tiramisù',
                'ingredients' => 'Uova, Latte, Cacao, Caffè',
                'plate_description' => 'Gustoso Tiramisù fatto in casa',
                'plate_price' => 4.00,
                'visibility' => 1,
                'plate_image' => 'plate_img/Tiramisu_650x433_wm.webp',
            ],
            [
                'restaurant_id' => 7,
                'plate_name' => 'Pizza Mascarpone, Speck e Noci',
                'ingredients' => 'Pizza, latte, Speck, Noci, Uova',
                'plate_description' => 'Golosa Pizza con Mascarpone, Speck e Noci',
                'plate_price' => 9.00,
                'visibility' => 1,
                'plate_image' => 'plate_img/Pizza-mascarpone-speck-e-noci_780x520_wm.webp',
            ],
            [
                'restaurant_id' => 7,
                'plate_name' => 'Maritozzi Panna e Nutella',
                'ingredients' => 'Uova, Latte, Nutella',
                'plate_description' => 'Golosissimi maritozzi artigianali con ripieno di panna e nutella',
                'plate_price' => 3.00,
                'visibility' => 1,
                'plate_image' => 'plate_img/maritozzi-panna-e-nutella.jpg',
            ],
            [
                'restaurant_id' => 8,
                'plate_name' => 'Bistecca alla fiorentina',
                'ingredients' => 'Carne, sale, rosmarino',
                'plate_description' => 'Taglio di lombata di bovino adulto',
                'plate_price' => 16.00,
                'visibility' => 1,
                'plate_image' => 'plate_img/Bistecca-alla-fiorentina.webp',
            ],
            [
                'restaurant_id' => 8,
                'plate_name' => 'Kebab fatto in casa',
                'ingredients' => 'Carne, pane, mozzarella',
                'plate_description' => 'Rivisitazione italiana del conosciutissimo kebab',
                'plate_price' => 6.00,
                'visibility' => 1,
